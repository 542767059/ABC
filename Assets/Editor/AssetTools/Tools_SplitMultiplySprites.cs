...
/// <summary>
/// 将Multiply格式的Sprite分割为单张图片,保存为png格式,保证Sprite中的锚点处于输出的PNG的中央位置
/// </summary>
public class Tools_SplitMultiplySprites : Editor
{
    ...
    [MenuItem("Assets/Tools/导出选中及选中的文件夹中Multiply Sprite")]
