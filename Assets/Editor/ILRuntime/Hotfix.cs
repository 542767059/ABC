...
namespace ZJY.Editor
{
    public static class Hotfix
    {
        ...
        static void init(AssemblyDefinition assembly)
        {
            ...
            delegateBridgeType = assembly.MainModule.Types.Single(t => t.FullName == "ILHotfix.DelegateBridge");
        ...
        [UnityEditor.MenuItem("Game Framework/ILRuntime/Hotfix Inject In Editor", false, 3)]
        ...
        public static void HotfixInject(string inject_assembly_path, Func<HashSet<string>> fun)
        {
            ...
            try
            {
                ...
                var hotfixAttributeType = assembly.MainModule.Types.Single(t => t.FullName == "ILHotfix.HotfixAttribute");
        ...
        class StrMethod
        {
            ...
            public void Sorted()
            {
                methods.Sort((x, y) =>
                {
                    ...
                    if (kx == ky)
                    {
                        UnityEngine.Debug.LogWarning("key same! + " + x.Name);
                    }
