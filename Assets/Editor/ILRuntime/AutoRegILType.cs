namespace ZJY.Editor
{
    ...
    static partial class AutoRegILType
    {
        ...
        {
            if (type.Assembly.ManifestModule.Name == "Hotfix.dll")
                return true;

            string ns = type.FullName;
            if (string.IsNullOrEmpty(ns))
                return false;
            if (ns.Contains("Hotfix."))
                return true;
        ...
        public static void Build()
        {
            ...
            Assembly assembly = Assembly.LoadFile(Application.dataPath + "/../Hotfix/bin/Debug/Hotfix.dll");
