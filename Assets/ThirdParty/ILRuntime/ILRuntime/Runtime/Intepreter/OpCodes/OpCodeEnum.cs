...
namespace ILRuntime.Runtime.Intepreter.OpCodes
{
    enum OpCodeEnum
    {
        ...
        Arglist,
        /// <summary>
        /// 比较两个值如果这两个值相等，则将整数值 1 (int32) 推送到计算堆栈上；否则，将 0 (int32) 推送到计算堆栈上
        /// </summary>
        Ceq,
        /// <summary>
        /// 比较两个值如果第一个值大于第二个值，则将整数值 1 (int32) 推送到计算堆栈上；反之，将 0 (int32) 推送到计算堆栈上
        /// </summary>
        Cgt,
        /// <summary>
        /// 比较两个无符号的或不可排序的值如果第一个值大于第二个值，则将整数值 1 (int32) 推送到计算堆栈上；反之，将 0 (int32) 推送到计算堆栈上
        /// </summary>
        Cgt_Un,
        /// <summary>
        /// 比较两个值如果第一个值小于第二个值，则将整数值 1 (int32) 推送到计算堆栈上；反之，将 0 (int32) 推送到计算堆栈上
        /// </summary>
        Clt,
        /// <summary>
        /// 比较无符号的或不可排序的值 value1 和 value2如果 value1 小于 value2，则将整数值 1 (int32 ) 推送到计算堆栈上；反之，将 0 ( int32 ) 推送到计算堆栈上
        /// </summary>
        Clt_Un,
        /// <summary>
