...
namespace ZJY.Framework
{
    public partial class GameEntry : MonoBehaviour
    {
        ...
        internal static void RegisterBaseComponent(GameBaseComponent component)
        {
            ...
            LinkedListNode<GameBaseComponent> current = m_BaseComponentList.First;
            while (current != null)
            {
            ...
            if (current != null)
            {
                m_BaseComponentList.AddBefore(current, component);
            }
            else
            {
        ...
        {
            //关闭所有的基础组件
            for (LinkedListNode<GameBaseComponent> current = m_BaseComponentList.Last; current != null; current = current.Previous)
            {
