...
namespace ZJY.Framework
{
    ...
    public class EntityManager : ManagerBase
    {
        ...
        private void LoadEntityFailureCallback(string entityAssetName, string errorMessage, object userData)
        {
            ...
            {
                ShowEntityFailureCallBack(showEntityInfo.EntityId, entityAssetName, showEntityInfo.EntityGroup.Name, showEntityInfo.EntityLogicType, appendErrorMessage, showEntityInfo.UserData);
                return;
            }
        ...
        private void LoadEntityUpdateCallback(string entityAssetName, float progress, object userData)
        {
            ...
            {
                ShowEntityUpdateCallBack(showEntityInfo.EntityId, entityAssetName, showEntityInfo.EntityGroup.Name, showEntityInfo.EntityLogicType, progress, showEntityInfo.UserData);
            }
        }
        ...
        private void LoadEntityDependencyAssetCallback(string entityAssetName, string dependencyAssetName, int loadedCount, int totalCount, object userData)
        {
            ...
            {
                ShowEntityDependencyAssetCallBack(showEntityInfo.EntityId, entityAssetName, showEntityInfo.EntityGroup.Name, showEntityInfo.EntityLogicType, dependencyAssetName, loadedCount, totalCount, showEntityInfo.UserData);
            }
        }
        #endregion
