...
namespace ZJY.Framework
{
    ...
    public class ResourceUpdater
    {
        ...
        public Action<bool> ResourceUpdateAllComplete;
        ...
        public void AddResourceUpdate(string resourceName, int length, int hashCode, int zipLength, int zipHashCode, string resourcePath)
        {
            m_UpdateWaitingInfo.Add(new UpdateInfo(resourceName, length, hashCode, zipLength, zipHashCode, resourcePath));
        }
