...
namespace ZJY.Framework
{
    ...
    public class ResourceManager : ManagerBase, IDisposable
    {
        ...
        private readonly AssetPool<AssetInfo> m_AssetPool;
        private readonly AssetPool<AssetBundleInfo> m_AssetBundlePool;
        ...
        public byte[] UpdateFileCache
        {
            get
            {
                return m_UpdateFileCache;
            }
        }

        public Stream DecompressCache
        {
            get
            {
                return m_DecompressCache;
            }
            set
            {
                m_DecompressCache = value;
            }
        }
        ...
        public float ResourceAutoReleaseInterval
        {
            get
            {
                return m_AssetBundlePool.AutoReleaseInterval;
            }
            set
            {
                m_AssetBundlePool.AutoReleaseInterval = value;
            }
        }
        ...
        public float ResourceExpireTime
        {
            get
            {
                return m_AssetBundlePool.ExpireTime;
            }
            set
            {
                m_AssetBundlePool.ExpireTime = value;
            }
        }
        ...
        public int UpdateFileCacheLength
        {
            ...
            set
            {
                ...
                {
                    throw new Exception("You can not use UpdateFileCacheLength at this time.");
                }
        ...
        internal void OnUpdate(float deltaTime, float unscaledDeltaTime)
        {
            ...
            m_AssetBundlePool.OnUpdate(deltaTime, unscaledDeltaTime);
        ...
        public void UnloadAsset(UnityEngine.Object asset)
        {
            ...
            m_AssetPool.UnspawnAsset(asset);
        }
        ...
        {
            m_AssetPool.UnloadUnusedAssets();
            m_AssetBundlePool.UnloadUnusedAssets();
        }
        ...
        {
            resourceLoader.SetAssetPool(m_AssetPool, m_AssetBundlePool);
        ...
        private void OnUpdaterResourceUpdateAllComplete(bool result)
        {
            ...
            UpdateResourcesCompleteCallback(result);
