...
namespace ZJY.Framework
{
    public abstract class UIForm : UIFormBase
    {
        ...
        protected override void OnInit(object userData)
        {
            ...
            gameObject.SetLayerRecursively(Constant.Leyer.UILayerId);
        }
        ...
        protected internal override void OnOpen(object userData)
        {
            ...
            if (!UIGroup.Name.Equals("Loading"))
            {
        ...
        /// 打开窗口
        /// </summary>
        /// <param name="uiformId">要打开的窗口Id</param>
        public virtual void OpenUIForm(int uiformId)
        {
