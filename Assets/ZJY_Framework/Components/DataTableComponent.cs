...
namespace ZJY.Framework
{
    ...
    public class DataTableComponent : GameBaseComponent
    {
        ...
        private void OnLoadDataTableSuccess(string dataTableAssetName, float duration, object userData)
        {
            ...
            {
                GameEntry.Event.CommonEvent.Dispatch(this, GameEntry.Pool.SpawnClassObject<LoadDataTableSuccessGameEvent>().Fill(dataTableAssetName, duration, userData));
            }
        }
        ...
        private void OnLoadDataTableFailure(string dataTableAssetName, string errorMessage, object userData)
        {
            ...
            {
                GameEntry.Event.CommonEvent.Dispatch(this, GameEntry.Pool.SpawnClassObject<LoadDataTableFailureGameEvent>().Fill(dataTableAssetName, errorMessage, userData));
            }
        }
        ...
        private void OnLoadDataTableUpdate(string dataTableAssetName, float progress, object userData)
        {
            ...
            {
                GameEntry.Event.CommonEvent.Dispatch(this, GameEntry.Pool.SpawnClassObject<LoadDataTableUpdateGameEvent>().Fill(dataTableAssetName, progress, userData));
            }
        }
        ...
        private void OnLoadDataTableDependencyAsset(string dataTableAssetName, string dependencyAssetName, int loadedCount, int totalCount, object userData)
        {
            ...
            {
                GameEntry.Event.CommonEvent.Dispatch(this, GameEntry.Pool.SpawnClassObject<LoadDataTableDependencyAssetGameEvent>().Fill(dataTableAssetName, dependencyAssetName, loadedCount, totalCount, userData));
            }
        }
    }
}
