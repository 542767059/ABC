...
namespace ZJY.Framework
{
    ...
    public class UIComponent : GameBaseComponent
    {
        ...
        [SerializeField]
        private int m_StandardWidth = 1920;
        
        [SerializeField]
        private int m_StandardHeight = 1080;
        ...
        /// 当前分辨率比值
        /// </summary>
        private float m_currstandard = 0;

        /// <summary>
        /// 普通窗口适配缩放
        /// </summary>
        public void NormalFormScaler()
        {
            AutoCanvasScaler();
        }
        ...
        {
            m_currstandard = Screen.width / (float)Screen.height;
            if (m_currstandard > m_standardScreen)
            {//设置为0
                SetCanvasScalerOne();
            }
            else
        ...
        /// 设置画布宽高缩放为1
        /// </summary>
        public void SetCanvasScalerOne()
        {
            SetCanvasScaler(1);
        }
        ...
        /// 设置画布宽高缩放为0
        /// </summary>
        public void SetCanvasScalerZero()
        {
            SetCanvasScaler(0);
        }
        ...
        /// 设置画布宽高缩放
        /// </summary>
        public void SetCanvasScaler(float scaler)
        {
            m_CanvasScaler.matchWidthOrHeight = scaler;
        }
