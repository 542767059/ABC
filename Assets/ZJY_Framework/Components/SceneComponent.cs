    ...
    public class SceneComponent : GameBaseComponent
    {
        ...
        private void OnLoadSceneSuccess(string sceneAssetName, UnityEngine.Object asset, float duration, object userData)
        {
            ...
            if (m_EnableLoadSceneSuccessEvent)
            {
                ...
                GameEntry.Event.CommonEvent.Dispatch(this, GameEntry.Pool.SpawnClassObject<LoadSceneSuccessGameEvent>().Fill(sceneAssetName, duration, userData));
            }
        }
        ...
        private void OnLoadSceneFailure(string sceneAssetName, string errorMessage, object userData)
        {
            ...
            {
                GameEntry.Event.CommonEvent.Dispatch(this, GameEntry.Pool.SpawnClassObject<LoadSceneFailureGameEvent>().Fill(sceneAssetName, errorMessage, userData));
        ...
        private void OnLoadSceneUpdate(string sceneAssetName, float progress, object userData)
        {
            ...
            {
                GameEntry.Event.CommonEvent.Dispatch(this, GameEntry.Pool.SpawnClassObject<LoadSceneUpdateGameEvent>().Fill(sceneAssetName, progress, userData));
        ...
        private void OnLoadSceneDependencyAsset(string sceneAssetName, string dependencyAssetName, int loadedCount, int totalCount, object userData)
        {
            ...
            {
                GameEntry.Event.CommonEvent.Dispatch(this, GameEntry.Pool.SpawnClassObject<LoadSceneDependencyAssetGameEvent>().Fill(sceneAssetName,  dependencyAssetName,  loadedCount,  totalCount,  userData));
        ...
        private void OnUnloadSceneSuccess(string sceneAssetName, object userData)
        {
            ...
            {
                GameEntry.Event.CommonEvent.Dispatch(this, GameEntry.Pool.SpawnClassObject<UnloadSceneSuccessGameEvent>().Fill(sceneAssetName, userData));
        ...
        private void OnUnloadSceneFailure(string sceneAssetName, object userData)
        {
            ...
            {
                GameEntry.Event.CommonEvent.Dispatch(this, GameEntry.Pool.SpawnClassObject<UnloadSceneFailureGameEvent>().Fill(sceneAssetName, userData));
