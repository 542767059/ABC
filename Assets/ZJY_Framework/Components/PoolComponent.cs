...
namespace ZJY.Framework
{
    ...
    public class PoolComponent : GameBaseComponent
    {
        ...
        /// </summary>
        [SerializeField]
        private float m_ClearCalssObjectInterval = 60;
        ...
        public float ClearClassObjectInterval
        {
            get
            {
                return m_PoolManager.ClearClassObjectInterval;
            }
            set
            {
                m_PoolManager.ClearClassObjectInterval = value;
            }
        }
        ...
        /// <returns></returns>
        public object SpawnClassObject(Type type)
        {
            return m_PoolManager.ClassObjectPool.Spawn(type);
        }
        #endregion
        ...
        public Dictionary<string, byte> ClassObjectCount
        {
            get
            {
                return m_PoolManager.ClassObjectPool.ClassObjectCount;
            }
        }
        ...
        public Dictionary<string, Queue<object>> ClassObjetPoolDic
        {
            get
            {
                return m_PoolManager.ClassObjectPool.ClassObjetPoolDic;
            }
        }
