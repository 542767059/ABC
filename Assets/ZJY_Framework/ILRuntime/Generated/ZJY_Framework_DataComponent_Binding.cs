...
{
    unsafe class ZJY_Framework_DataComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ZJY.Framework.DataComponent);
            args = new Type[]{};
        ...
        static StackObject* get_UserData_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ZJY.Framework.DataComponent instance_of_this_method = (ZJY.Framework.DataComponent)typeof(ZJY.Framework.DataComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
