...
{
    unsafe class ZJY_Framework_EntityData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ZJY.Framework.EntityData);
        ...
        static StackObject* set_Position_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ZJY.Framework.EntityData instance_of_this_method = (ZJY.Framework.EntityData)typeof(ZJY.Framework.EntityData).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
