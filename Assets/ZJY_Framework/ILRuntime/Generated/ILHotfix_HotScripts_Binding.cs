...
{
    unsafe class ILHotfix_HotScripts_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILHotfix.HotScripts);
            ...
            app.RegisterCLRMethodRedirection(method, ReplaceField_0);


        }


        static StackObject* ReplaceField_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ILHotfix.HotScripts.ReplaceField(@type, @fieldName, @info);
