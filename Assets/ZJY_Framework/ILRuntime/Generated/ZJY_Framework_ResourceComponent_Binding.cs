...
{
    unsafe class ZJY_Framework_ResourceComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ZJY.Framework.ResourceComponent);
            args = new Type[]{typeof(System.String), typeof(System.Type), typeof(System.Int32), typeof(ZJY.Framework.LoadAssetCallbacks), typeof(System.Object)};
        ...
        static StackObject* LoadAsset_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ZJY.Framework.LoadAssetCallbacks @loadAssetCallbacks = (ZJY.Framework.LoadAssetCallbacks)typeof(ZJY.Framework.LoadAssetCallbacks).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            ZJY.Framework.ResourceComponent instance_of_this_method = (ZJY.Framework.ResourceComponent)typeof(ZJY.Framework.ResourceComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.LoadAsset(@assetName, @assetType, @priority, @loadAssetCallbacks, @userData);
        ...
        static StackObject* UnloadAsset_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.Object @asset = (UnityEngine.Object)typeof(UnityEngine.Object).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.UnloadAsset(@asset);
