...
{
    unsafe class ZJY_Framework_Log_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ZJY.Framework.Log);
            ...
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("Error", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Error_5);
        ...
        static StackObject* Info_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ZJY.Framework.Log.Info(@format, @arg0);
        ...
        static StackObject* Error_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ZJY.Framework.Log.Error(@format, @arg0, @arg1, @arg2);
        ...
        static StackObject* Warning_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ZJY.Framework.Log.Warning(@format, @arg0, @arg1);
        ...
        static StackObject* Warning_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ZJY.Framework.Log.Warning(@format, @arg0);
        ...
        static StackObject* Warning_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ZJY.Framework.Log.Warning(@message);

            return __ret;
        }

        static StackObject* Error_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            ZJY.Framework.Log.Error(@message);
