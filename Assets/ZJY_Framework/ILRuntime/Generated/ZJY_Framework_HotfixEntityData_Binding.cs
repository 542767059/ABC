...
{
    unsafe class ZJY_Framework_HotfixEntityData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ZJY.Framework.HotfixEntityData);
        ...
        static StackObject* Fill_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ZJY.Framework.HotfixEntityData instance_of_this_method = (ZJY.Framework.HotfixEntityData)typeof(ZJY.Framework.HotfixEntityData).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ZJY.Framework.HotfixEntityData();
