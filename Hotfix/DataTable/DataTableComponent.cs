...
namespace Hotfix
{
    ...
    /// 数据表组件
    /// </summary>
    public class DataTableComponent : IHotfixComponent
    {
        ...
        [SerializeField]
        private bool m_EnableLoadDataTableUpdateEvent = true;
        ...
        private void OnLoadDataTableSuccess(string dataTableAssetName, float duration, object userData)
        {
            ...
            {
                HotfixEntry.Event.Dispatch(this, HotfixEntry.Pool.SpawnClassObject<LoadDataTableSuccessGameEvent>().Fill(dataTableAssetName, duration, userData));
            }
        }
        ...
        private void OnLoadDataTableFailure(string dataTableAssetName, string errorMessage, object userData)
        {
            ...
            {
                HotfixEntry.Event.Dispatch(this, HotfixEntry.Pool.SpawnClassObject<LoadDataTableFailureGameEvent>().Fill(dataTableAssetName, errorMessage, userData));
            }
        }
        ...
        private void OnLoadDataTableUpdate(string dataTableAssetName, float progress, object userData)
        {
            ...
            {
                HotfixEntry.Event.Dispatch(this, HotfixEntry.Pool.SpawnClassObject<LoadDataTableUpdateGameEvent>().Fill(dataTableAssetName, progress, userData));
            }
        }
